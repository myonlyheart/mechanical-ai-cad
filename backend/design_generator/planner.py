    ...
    "bearing": [
        {
            "id": "deep_groove",
            "name": "深沟球轴承",
            "description": "标准深沟球，通用旋转支撑",
            "weight_factor": 1.0,
            "strength_factor": 1.0,
            "time_factor": 1.0,
            "params_override": {"bearing_type": "deep_groove"},
        },
        {
            "id": "flanged",
            "name": "法兰轴承",
            "description": "带法兰凸缘，轴向定位",
            "weight_factor": 1.15,
            "strength_factor": 1.0,
            "time_factor": 1.1,
            "params_override": {"bearing_type": "flanged"},
        },
        {
            "id": "thrust",
            "name": "推力轴承",
            ...
            "strength_factor": 0.8,
            "time_factor": 1.0,
            "params_override": {"bearing_type": "thrust"},
        },
        {
            "id": "sealed",
            "name": "密封轴承",
            "description": "双面密封，免维护",
            "weight_factor": 1.05,
            "strength_factor": 1.0,
            "time_factor": 1.0,
            "params_override": {"bearing_type": "deep_groove", "seal_type": "sealed"},
        },
    ],
    "shaft": [
        {
